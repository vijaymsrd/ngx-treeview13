...
export declare class TreeviewComponent implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TreeviewComponent, "ngx-treeview", never, { "headerTemplate": "headerTemplate"; "itemTemplate": "itemTemplate"; "items": "items"; "config": "config"; }, { "selectedChange": "selectedChange"; "filterChange": "filterChange"; }, never, never>;
}
